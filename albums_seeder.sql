...
VALUES ('Michael Jackson', 'Thriller', 1982, 47.3, 'Pop/Rock/R&B'),
       ...
       ('Fleetwood Mack', 'Rumours', 1977, 27.9, 'Soft Rock'),
       ('Grease', 'Grease: The Original Soundtrack from the motion picture', 1978, 14.4, 'Soundtrack'),
       ...
       ('Dire Straits', 'Brothers in Arms', 1985, 19.6, 'Rock'),
       ('James Horner', 'Titanic: Music from thte Motion Picture', 1997, 18.1, 'Soundtrack'),
