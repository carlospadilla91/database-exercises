...
CREATE TABLE pets (
                      ...
                      owner_name VARCHAR(30),
                      age INT,
                      UNIQUE unique_owner_name (owner_name) # adding an index to another column; UNIQUE will not allow owner_name to be repeated in this table
);
...
CREATE TABLE pets (
                      ...
                      owner_name VARCHAR(30),
                      age INT,
                      UNIQUE unique_owner_name (pet_name, owner_name) # adding an index to another column; UNIQUE will not allow owner_name and pet_name to be repeated in table
);
